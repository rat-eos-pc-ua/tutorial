...
Upon accessing the [https://data.atnog-iot4fire.av.it.pt/](https://data.atnog-iot4fire.av.it.pt/)  users are presented with several types of visualizations aimed at providing clear and comprehensive insights into meteorological conditions and fire risks across Portugal and Spain 

# Data model:
The data model that needs to be followed can be seen here: [https://atnog-iot4fire.av.it.pt/swagger-ui/]( https://atnog-iot4fire.av.it.pt/swagger-ui/)
